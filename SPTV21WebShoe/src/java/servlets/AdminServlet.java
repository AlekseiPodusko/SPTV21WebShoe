...
public class AdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Customer authUser = (Customer) session.getAttribute("authUser");
        if(authUser == null){
            request.setAttribute("info", "Авторизуйтесь!");
            request.getRequestDispatcher("/showLogin").forward(request, response);
        }
        ...
        switch(path) {
            case "/showChangeRole":
                ...
                List<Customer> users = userFacade.findAll();
            ...
            case "/changeRole":
                ...
                Customer u = userFacade.find(Long.parseLong(userId));
            ...
            case "/showUsersList":
                List<Customer> usersList = userFacade.findAll();
